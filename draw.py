...
def add_box( points, x, y, z, width, height, depth ):
    add_edge(points, x, y, z, x, y - height, z) # |d
    add_edge(points, x, y - height, z, x + width, y - height, z) # --r
    add_edge(points, x + width, y - height, z, x + width, y, z) # |u
    add_edge(points, x + width, y, z, x, y, z) # --l
    add_edge(points, x, y, z - depth, x, y - height, z - depth) # |d
    add_edge(points, x, y - height, z - depth, x + width, y - height, z - depth) # --r
    add_edge(points, x + width, y - height, z - depth, x + width, y, z - depth) # |u
    add_edge(points, x + width, y, z - depth, x, y, z - depth) # --l
...
def generate_torus( points, cx, cy, cz, r0, r1, step ):
    ...
    for i in range(step):
        for w in range(step):
            ...
            x = math.cos(phi) * (r0 * math.cos(t) + r1) + cx
            y = r0 * math.sin(t) + cy
            z = -math.sin(phi) * (r0 * math.cos(t) + r1) + cz
